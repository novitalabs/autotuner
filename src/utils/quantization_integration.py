...
from utils.quantization_mapper import get_runtime_args, resolve_quant_config, validate_quant_config
...
def expand_quantization_presets(quant_config: Optional[Dict[str, Any]]) -> List[Dict[str, Any]]:
	"""
...
def expand_quant_config_to_parameter_spec(quant_config: Optional[Dict[str, Any]]) -> Dict[str, Any]:
	"""
...
def merge_parameters_with_quant_config(
	base_parameters: Dict[str, Any], quant_config: Optional[Dict[str, Any]]
) -> Dict[str, Any]:
	"""
...
def prepare_runtime_parameters(
	base_runtime: str, params: Dict[str, Any], model_path: str, model_config: Optional[Dict] = None
) -> Dict[str, Any]:
	"""
	...
	if parallel_config:
		...
		regular_params = prepare_runtime_parallel_parameters(base_runtime=base_runtime, params=parallel_prefixed_params)
