...
def build_cli_args(
	parameters: Dict[str, Any], *, skip_prefixes: tuple = ("__",), bool_flags: bool = True, add_prefix: bool = True
) -> List[str]:
	"""
...
def build_cli_string(parameters: Dict[str, Any], **kwargs) -> str:
	"""
...
def merge_cli_args(base_args: List[str], additional_params: Dict[str, Any], **kwargs) -> List[str]:
	"""
...
def filter_cli_args(args: List[str], allowed_params: Set[str], prefix: str = "--") -> List[str]:
	"""
