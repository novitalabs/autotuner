...
def sanitize_docker_name(name: str) -> str:
	...
	return sanitize_name(
		name, allowed_pattern=r"[^a-z0-9_.-]", max_len=255, must_start_letter=False, allow_underscore=True
	)
...
def sanitize_k8s_name(name: str) -> str:
	...
	"""
	return sanitize_name(
		name, allowed_pattern=r"[^a-z0-9-]", max_len=63, must_start_letter=True, allow_underscore=False
	)
