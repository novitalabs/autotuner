...
def register_tool(category: ToolCategory, requires_auth: bool = False, auth_scope: AuthorizationScope = None):
	"""
	...
	def decorator(func: Callable) -> Callable:
		...
		if requires_auth and auth_scope is None:
			raise ValueError(f"Tool {func.__name__} requires authorization but no auth_scope provided")
