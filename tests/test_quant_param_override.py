...
def test_alias_overrides_existing_quant_param():
    """Alias keys should override existing __quant__ entries."""
    base_params = {
        "__quant__kvcache_dtype": ["auto"],
        "kv-cache-dtype": ["fp8_e5m2"],
    }

    merged = merge_parameters_with_quant_config(base_params, quant_config=None)
    assert merged["__quant__kvcache_dtype"] == ["fp8_e5m2"]
